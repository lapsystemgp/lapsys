...
export default function LabDashboardPage() {
  ...
  useEffect(() => {
    // Standard fetch with assumed credentials MVP. 
    // Need an interceptor for real app if using Bearer token without cookies.
    fetch('http://localhost:3000/api/lab/data')
      .then((res) => {
    ...
    <div className="min-h-screen bg-zinc-950 text-white p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-xl">
          <h2 className="text-xl font-semibold mb-4 text-zinc-200">Protected Lab Data</h2>
