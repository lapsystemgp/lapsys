...
abstract class $SessionStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({SessionStatus status, AuthUser? user, String? error});
...
class _$SessionStateImpl implements _SessionState {
  const _$SessionStateImpl(
      {this.status = SessionStatus.initial, this.user, this.error});
  ...
  @override
  String toString() {
    return 'SessionState(status: $status, user: $user, error: $error)';
  }
...
abstract class _SessionState implements SessionState {
  const factory _SessionState(
      {final SessionStatus status,
      final AuthUser? user,
      final String? error}) = _$SessionStateImpl;
